...
fn read_ctr_el0() -> u64 {
    let ctr_el0: u64;
    unsafe {
        asm!("mrs $0, ctr_el0" : "=r"(ctr_el0) ::: "volatile");
    }
    ctr_el0
}
...
pub trait Cache {
    ...
    fn flush_range<A: Dsb>(start: usize, end: usize, domain: A) {
    ...
    /// shareability domain.
    fn flush_area<A: Dsb>(start: usize, size: usize, domain: A) {
